...
def hamiltonian_fn(coords):
    ...
    H = 2*(1-np.cos(q)) + p**2 # pendulum hamiltonian
    return H
...
def get_trajectory(t_span=[0,3], timescale=15, radius=None, y0=None, noise_std=0.05, **kwargs):
    ...
    if radius is None:
        radius = np.random.rand()*1.8 + 0.2 # sample a range of radii
